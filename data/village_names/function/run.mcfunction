...
execute as @e[type=villager,tag=eden.villagename.set,limit=32,sort=random] at @s unless entity @e[type=marker,tag=village.name,distance=..96] run tag @s remove eden.villagename.set
