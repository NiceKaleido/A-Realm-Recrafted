...
execute as @a at @s if items entity @s weapon.mainhand #minecraft:axes[minecraft:custom_model_data,minecraft:custom_data] run function migration:axes
execute as @a at @s if items entity @s weapon.mainhand #minecraft:hoes[minecraft:custom_model_data,minecraft:custom_data] run function migration:hoes
execute as @a at @s if items entity @s weapon.mainhand #minecraft:pickaxes[minecraft:custom_model_data,minecraft:custom_data] run function migration:pickaxes
execute as @a at @s if items entity @s weapon.mainhand #minecraft:swords[minecraft:custom_model_data,minecraft:custom_data] run function migration:swords
execute as @a at @s if items entity @s weapon.mainhand #minecraft:shovels[minecraft:custom_model_data,minecraft:custom_data] run function migration:shovels
