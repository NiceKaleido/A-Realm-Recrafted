...
execute if data storage eden:temp waypoint{dimension: "eden:astral_plane"} run data modify storage eden:temp waypoint.dimension_name set value "Astral Plane"
...
unless data storage eden:temp waypoint{dimension: "eden:astral_plane"} \
