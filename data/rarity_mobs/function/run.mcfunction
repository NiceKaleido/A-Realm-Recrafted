...
execute as @e[type=#eden:valid_for_rarity,predicate=!eden:entity/exclude_from_rarity] if score @s rarity_mobs.timer matches 60.. run function rarity_mobs:choose_rarity
