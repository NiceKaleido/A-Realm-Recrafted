...
tellraw @s [{"text":"▊ ","color":"aqua","bold":true,"italic":false},{"text":"Compasses generally point you in the right direction but they also can teleport you right back to the loadstone they are linked with.","color":"gray","bold":false,"italic":false}]
