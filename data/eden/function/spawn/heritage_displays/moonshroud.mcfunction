...
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"The Moonshroud are beings of grace and silence, their movements fluid and almost spectral. Their skin reflects the silvered hues of moonlight, and their eyes glow faintly with the pale luminescence of the lunar surface, giving them an otherworldly, ghost-like appearance.","color":"gray","bold":false,"italic":false}]

tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":" ","color":"gray","bold":false,"italic":false}]
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"Characteristics:","color":"gray","bold":false,"italic":false,"underlined":true}]
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"• 5.5 Base Attack Speed","color":"gray","bold":false,"italic":false}]
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"• 0.7 Base Attack Damage","color":"gray","bold":false,"italic":false}]
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"• Infinite Night Vision Effect","color":"gray","bold":false,"italic":false}]
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"• Small Strength Effect When It's Night","color":"gray","bold":false,"italic":false}]
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"• Guardian Entity: 2 Wolves","color":"gray","bold":false,"italic":false}]
tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":" ","color":"gray","bold":false,"italic":false}]

tellraw @s [{"text":"▊ ","color":"blue","bold":true,"italic":false},{"text":"You can join this Heritage by giving the item to the Villager in this room.","color":"gray","bold":false,"italic":false},{"text":" Choose wisely! Heritages can only be changed once every month.","color":"gray","bold":false,"italic":false}]
